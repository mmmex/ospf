...
Если ранее окно терминала на шаге 2 и 3 [раздела Выполнение асимметричной маршрутизации вручную](#Выполнение асимметричной маршрутизации вручную) небыло закрыто, то следующие 5 пунктов можно пропустить.
